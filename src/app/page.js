...
export default function Home() {
  return (
    <div className="container my-12 lg:my-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 md:px-40 items-center">
        <div className="text-side flex flex-col gap-6 lg:gap-8">
          <h1 className="text-heading-1-bold">Zachary is a designer who’s all about making people's lives easier, one experience at a time.</h1>
        ...
        <div className="photo-side">
          <Image
            ...
            className="rounded-lg shadow-zg"

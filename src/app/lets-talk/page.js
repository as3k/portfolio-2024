          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              >
                ...
                <div>
                  <p className="text-body-1-semibold text-white">Email</p>
                  <p className="text-microcopy-1 text-gray-400">zack@zkg.io</p>
                </div>
              </Link>
              ...
              >
                ...
                <div>
                  <p className="text-body-1-semibold text-white">LinkedIn</p>

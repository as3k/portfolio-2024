...
I'm the only product engineer on the platform. I own features end to end — problem framing, design, implementation, production. Over three years, that's meant working across payment flows, operations tooling, infrastructure, and security.
